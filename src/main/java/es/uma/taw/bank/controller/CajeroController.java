...
public class CajeroController {
    ...
    @PostMapping("/retirar")
    public String retirar(Model model, @RequestParam("cuenta") Integer idCuenta,
    ...
    public String filtrarOperaciones(Model model, @RequestParam("cuenta") Integer idCuenta,
                                     @ModelAttribute("filtro") FiltroOperaciones filtro) {
    ...
    public String cambiarA(Model model, @RequestParam("cuenta") Integer idCuenta,
                           @RequestParam("moneda") String monedaDestino) {
        CuentaDTO c = cuentaService.buscarCuenta(idCuenta);
    ...
    public String retirarCambio(Model model, @RequestParam("cuenta") Integer idCuenta,
                                @RequestParam("cantidad") Double cantidad) {
        cuentaService.sumarSaldo(idCuenta, -cantidad);
        return "redirect:/cajero/cuenta?cuenta=" + idCuenta;
    }
