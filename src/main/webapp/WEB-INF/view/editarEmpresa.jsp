...
<body>
<h1>Editar datos de ${registroEmpresa.empresa.nombre}</h1>
<form:form action="/empresa/${registroEmpresa.empresa.id}/editar/guardar" modelAttribute="registroEmpresa" method="post">
  ...
  <form:input path="empresa.nombre"/>
  <h2>Dirección</h2>
  <table>
    <tr>
