...
<body>
<h1>Editar persona fisicas</h1>
<form:form action="/persona/guardar" modelAttribute="registroPersona" method="post">
    ...
    <table>
        ...
        <tr>
            ...
            <td><input type="reset" value="Cancelar" onclick="location.href='/persona/'"></td>
            <td></td>
        </tr>
    </table>
</form:form>
